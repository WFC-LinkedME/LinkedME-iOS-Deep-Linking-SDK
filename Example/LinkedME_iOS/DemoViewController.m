...
- (IBAction)copyTestKey:(id)sender {
    ...
    NSArray * tgs = [[NSArray alloc]init];
    NSMutableArray * tgss = [[NSMutableArray alloc]init];
}
...
-(void)addPara{
    ...
    NSUserActivity *activity = [[NSUserActivity alloc]initWithActivityType:NSLocaleIdentifier];
    activity.webpageURL = [NSURL URLWithString:@"https://lkme.cc/AfC/CeG9o5VH8"];
    [[LinkedME getInstance] continueUserActivity:activity];
    
    return;
    
    
//    NSUserActivity *activity2 = [[NSUserActivity alloc]initWithActivityType:NSLocaleIdentifier];
//    activity2.webpageURL = [NSURL URLWithString:@"https://lkme.cc/AfC/Qwp6cTVaI"];
//
//    [[LinkedME getInstance] continueUserActivity:activity2];
    ...
    self.linkedUniversalObject.imageUrl = @"https://s3-us-west-1.amazonaws.com/linkedmehost/mosaic_og.png";
